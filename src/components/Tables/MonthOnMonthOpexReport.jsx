...
//         exportRows.push([ 
//             "Month-on-Month OPEX Report (in AED)", 
//         ]); 
...
//         const headerRowIndex = exportRows.findIndex( 
//             (r) => r?.[0] === "Expense Category" 
//         ); 
...
//                 return ` 
//                 <tr class="${isTotalRow ? "pdf-total-row" : ""}"> 
//                     ${row 
//                         .map( 
//                             (cell) => ` 
//                                 <td 
...
//             logo.onload = () => setTimeout(printPdf, 150); 
//             logo.onerror = () => setTimeout(printPdf, 150); 
//         } else { 
...
//         const tableHeaderFontSize = isViewAll ? 12 : 14; 
//         const tableBodyFontSize = isViewAll ? 13 : 14; 
//         const detailHeaderFontSize = isViewAll ? 12 : 13; 
//         const detailBodyFontSize = isViewAll ? 13 : 14; 
...
//                         }} 
//                     > 
//                         Month-on-Month OPEX Report <span style={{ color: "#6B7280", marginLeft: "6px" }}>(Amounts in {reportingCurrency || "AED"})</span> 
//                     </h3> 
...
export default function MonthOnMonthOpexReport({
    ...
    const handleExportPDF = () => {
        ...
        // PDF-only number formatting. Keeps the original export data unchanged
        // while preventing long decimal values from overflowing into adjacent cells.
        const formatPdfCell = (cell) => {
