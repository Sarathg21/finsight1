...
//         {selectedUser && (
//           <div className="users-details-panel">
//             <UserDetails
//               key={selectedUser.id}
//               user={selectedUser}
...
//         editUser={showEditUser ? selectedUser : null}
//         onClose={() => {
...
export default function UsersDashboard() {
  ...
  const fetchUserStats = async () => {
    try {
      ...
      setUserStats({
        ...
        noRole:
          response.data.users_without_role ?? 0,
      });
  ...
  return (
    ...
    >
      ...
      <div
        className="users-dashboard-content"
        style={{
          flex: 1,
          minHeight: 0,
          width: "100%",
