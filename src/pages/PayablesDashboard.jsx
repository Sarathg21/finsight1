...
// }
// /* ============================================================
//    COMMON NO-DATA / KPI ANIMATION HELPERS
//    ============================================================ */
// function NoDataAvailable({ minHeight = 185 }) {
//   return <div style={{ width: "100%", minHeight, display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", color: MUTED, fontSize: 11, fontWeight: 700 }}>No Data Available</div>;
// }
...
//             options={filterOptions.as_on_dates || []}
//             onChange={(value) => {
//               setFilters((prev) => ({ ...prev, as_on_date: value }));
//               setData(emptyDashboardData);
//               setAppliedFilters((prev) => ({ ...prev, as_on_date: value, year: Number(String(value).slice(0, 4)) || prev.year }));
//             }}
//           />
//           <button
//             type="button"
...
//             {data.topSuppliers?.length ? <DataTable columns={supplierColumns} rows={data.topSuppliers} fitColumns compactRows onRowClick={handleSupplierDrillDown} /> : <NoDataAvailable />}
//             {supplierRows.length > 0 && (
//               <div
//                 style={{
//                   display: "grid",
...
//             {data.overdueSummary?.length ? <DonutChart data={data.overdueSummary} total={kpis.overdue_payables} currency={currency} centerLabel="Overdue" legendBelow onSegmentClick={handleAgingDrillDown} /> : <NoDataAvailable minHeight={250} />}
//           </section>
...
//             value={viewFilters.as_on_date}
//             onChange={(value) => {
//               setViewFilters((prev) => ({ ...prev, as_on_date: value }));
//               setAppliedViewFilters((prev) => ({ ...prev, as_on_date: value }));
//               setPage(1);
//             }}
//           />
