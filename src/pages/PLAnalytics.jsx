...
//   const sectionLower = String(row?.section ?? '').trim().toLowerCase();
...
//   const isTax =
//     labelLower === 'tax' ||
//     labelLower === 'tax expense' ||
//     labelLower === 'income tax' ||
//     labelLower.includes('tax expense');

//   /*
//    * P&L variance treatment:
//    * - Income / Gross Profit / EBITDA / PBT / Net Profit:
//    *     higher Actual than comparison/target = favourable.
//    * - Cost of Sales / Expenses / Other Expenses / Tax:
//    *     lower Actual than comparison/target = favourable.
//    *
//    * This is presentation logic only. Backend values remain untouched.
//    */
//   const isCostLike =
//     sectionLower === 'cost of sales' ||
//     sectionLower === 'expenses' ||
//     sectionLower === 'other expenses' ||
//     isTax;
...
//   const getDisplayVariancePct = (actual, benchmark, backendValue) => {
//     const actualNum = toNumber(actual);
//     const benchmarkNum = toNumber(benchmark);

//     if (actualNum !== null && benchmarkNum !== null && benchmarkNum !== 0) {
//       const varianceAmount = isCostLike
//         ? benchmarkNum - actualNum
//         : actualNum - benchmarkNum;
//       return (varianceAmount / Math.abs(benchmarkNum)) * 100;
//     }

//     const backendNum = toNumber(backendValue);
//     if (backendNum === null) return null;

//     // Backend variance is assumed to be Actual - Benchmark. Reverse the
//     // sign for cost-like rows so positive always means favourable.
//     return isCostLike ? -backendNum : backendNum;
//   };

//   const varianceActualVsCompare = getDisplayVariancePct(
//     actualPTD,
//     comparePTD,
//     backendVarActualVsCompare
//   );

//   const varianceActualVsTarget = getDisplayVariancePct(
//     actualPTD,
//     targetPTD,
//     backendVarActualVsTarget
//   );

//   const varianceYTDVsTarget = getDisplayVariancePct(
//     actualYTD,
//     targetYTD,
//     backendVarYTDVsTarget
//   );
...
//         style={{
//           ...TDx,
//           color: varianceColor(varianceActualVsCompare),
...
//           const backendVarianceAmount = row.variance_amount;
//           const varVal = backendVarianceAmount !== undefined && backendVarianceAmount !== null
//             ? Number(backendVarianceAmount)
//             : (Number.isFinite(currentValue) && Number.isFinite(compareValue)
//               ? currentValue - compareValue
//               : null);

//           const backendVariancePct = row.variance_pct;
//           const varPct = backendVariancePct !== undefined && backendVariancePct !== null
//             ? Number(backendVariancePct)
//             : (
//               Number.isFinite(compareValue) && compareValue !== 0 && Number.isFinite(varVal)
//                 ? ((varVal / Math.abs(compareValue)) * 100)
//                 : null
//             );

//           // IMPORTANT: favourability comes directly from backend.
...
//     exportPL(section, appliedFilters, format)
//       .then(() => {
//         showToast(
...
//     if (section === 'kpi' || !section) {
//       showToast(
//         'KPI export is not available from the backend yet.',
//         'error'
//       );
//       return;
//     }

//     setViewAllExporting(`${section}-${format}`);
...
//               onReset={resetViewAllFilters}
//               loading={viewAllLoading}
//               onExport={(format) => handleViewAllExport(format, 'trend')}
//               exporting={viewAllExporting}
//             />
...
//               onReset={resetViewAllFilters}
//               loading={viewAllLoading}
//               onExport={(format) => handleViewAllExport(format, 'comparison')}
//               exporting={viewAllExporting}
//             />
//             {viewAllLoading ? <div style={{ padding: 24 }}><Skeleton h={220} /></div> : (
//               <ComparisonViewAll
...
//               onReset={resetViewAllFilters}
//               loading={viewAllLoading}
//               onExport={(format) => handleViewAllExport(format, 'expense')}
//               exporting={viewAllExporting}
//             />
//             {viewAllLoading ? <div style={{ padding: 24 }}><Skeleton h={220} /></div> : (
//               <ExpenseViewAll
...
//               onReset={resetViewAllFilters}
//               loading={viewAllLoading}
//               onExport={(format) => handleViewAllExport(format, 'statement')}
//               exporting={viewAllExporting}
//             />
