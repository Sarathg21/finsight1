...
const ROUTE_MODULE_MAP = {
  ...
  "/revenue": MODULE_CODES.SALES_REVENUE,
   ...
   "operating-expenses": MODULE_CODES.OPERATING_EXPENSES,
...
const PAGE_MODULE_MAP = {
  dashboard: MODULE_CODES.DASHBOARD,
  cfo_dashboard: MODULE_CODES.DASHBOARD,
  "cfo-dashboard": MODULE_CODES.DASHBOARD,
  "finsight-dashboard": MODULE_CODES.DASHBOARD,
  "exec-dashboard": MODULE_CODES.DASHBOARD,
  executive_dashboard: MODULE_CODES.DASHBOARD,

  pl: MODULE_CODES.PROFIT_LOSS,
  profit_loss: MODULE_CODES.PROFIT_LOSS,

  "balance-sheet": MODULE_CODES.BALANCE_SHEET,
  balance_sheet: MODULE_CODES.BALANCE_SHEET,

  revenue: MODULE_CODES.SALES_REVENUE,
  sales_revenue: MODULE_CODES.SALES_REVENUE,

  "fixed-assets": MODULE_CODES.FIXED_ASSETS,
  fixed_assets: MODULE_CODES.FIXED_ASSETS,
  ...
  "working-capital": MODULE_CODES.WORKING_CAPITAL,
  working_capital: MODULE_CODES.WORKING_CAPITAL,
  ...
  master_data: MODULE_CODES.MASTER_DATA,
};
